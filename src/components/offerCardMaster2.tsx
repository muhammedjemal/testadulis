...
import ProductMeta from "./productData";

export default function LensDemoMaster2() {
  const [hovering, setHovering] = useState(false);

  return (
    <div>
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#4A3420] to-[#332418] p-8 my-10">
        <Rays />
        <Beams />
 ...
 Original master work of Ethiopia as the Mother of Africa
            ...
            <br />
            <ProductMeta views={2516} favorites={49} />
          </motion.div>
        </div>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#FFB347" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#FFA500" />
      </g>
      <defs>
        <filter
...
const Rays = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      className={cn(
        "absolute left-0 top-0  pointer-events-none z-0",
        className
      )}
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.214779" stopColor="#FF8000" />
          <stop offset="0.781583" stopColor="#FF9933" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        >
          <stop offset="0.214779" stopColor="#FF8000" />
          <stop offset="0.781583" stopColor="#FFA500" stopOpacity="0" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.214779" stopColor="#FF8C00" />
          <stop offset="0.781583" stopColor="#FFB347" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop offset="1" stopColor="#FFC16D" stopOpacity="0" />
        </linearGradient>
        <linearGradient
