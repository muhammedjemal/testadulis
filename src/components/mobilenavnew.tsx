...
//                 width="28px"
//                 className={`${
//                   isSearchOpen ? "fill-black" : "fill-white"
//                 } fill-black  `}
...
const MobileNav = () => {
  ...
  return (
    <header
      className={`bg-white absolute top-12 left-0 right-0 z-10 transition-all duration-300 ease-in-out sm:hidden`}
    >
      <div className="container mx-auto px-4  flex justify-between items-center pb-2 relative">
        {/* Mobile Menu Icon */}
        {/* Logo */}
        <div className="flex items-center justify-evenly ">
          ...
          <Link href="/" className="flex-1 flex justify-center ml-20">
            {/* ${lobster.className} */}
            <span className={`text-2xl font-bold text-orange-500 font-bohemaz`}>
              Adulis
            </span>
          </Link>
          {/* Mobile Icon Container */}
