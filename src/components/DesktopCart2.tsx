...
//       <span
//         className="flex items-center text-gray-700 hover:text-gray-900 pl-1 "
//         onClick={toggleCart}
//       >
//         <svg
...
//             {cartItems.length > 0 ? ( // If there are items in the cart show the cart items.
...
//                   >
//                     <Image
//                       src={getImagePath(item.pathname)}
//                       alt="Product Image"
//                       width={100}
//                       height={100}
//                     />
...
const DesktopCart = () => {
  ...
  return (
    <div
      className="relative z-500 bg-white "
      style={{ cursor: "pointer", zIndex: 999 }}
    >
      {/* Cart Icon - assuming you'll style this as a clickable icon */}
      <span
        className={`flex items-center text-gray-700 hover:text-gray-900 pl-1 ${
          pathname.startsWith("/prod") ? "" : "cursor-none"
        }`}
        onClick={toggleCart}
      >
        <svg
          ...
          width="28px"
          className={`${
            pathname.startsWith("/prod") ? "fill-black" : "fill-white"
