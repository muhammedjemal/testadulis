...
const IndexPage = () => {
  ...
  useEffect(() => {
    const updateRandomValues = () => {
      setRandomX((Math.random() - 0.5) * 30);
      setRandomY((Math.random() - 0.5) * 30);
      setRandomBlur(Math.random() * 3);
    };
    updateRandomValues();
    const intervalId = setInterval(updateRandomValues, 5000);
    ...
    <Layout title="">
      <motion.img
        ...
        animate={{
          x: [0, randomX],
          y: [0, randomY],
          filter: [`blur(0px)`, `blur(${randomBlur}px)`],
        }}
        transition={{
          duration: 1.5,
          ease: "easeInOut",
      ...
      <div className="absolute bottom-5">
        <ul className="flex space-x-3">
          <li>
            <Link href="https://themeptation.net" legacyBehavior>
